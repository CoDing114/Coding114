...
Array.from ||
    (Array.from =
        ...
        function (t) {
            ...
            for (var c, u = n(o.length), l = e(r) ? Object(new r(u)) : new Array(u), p = 0; p < u; ) (c = o[p]), (l[p] = a ? (void 0 === i ? a(c, p) : a.call(i, c, p)) : c), (p += 1);
            return (l.length = u), l;
        })),
    Element.prototype.matches || (Element.prototype.matches = Element.prototype.webkitMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.mozMatchesSelector),
